...
module BetterErrors
  ...
  private
    ...
    def protected_app_call(env)
      ...
      #
      # This will have strange results in a multithreaded environment and another error is generated by a different
      # thread while this app request is being called.
